...
if [ $SECTION_CHOICE -le 12 ]; then
    ...
    if [ $MACHINE_CHOICE == '0' ] || [ $MACHINE_CHOICE == 'new' ]; then
        ...
        echo '[ General Tools: gkrellm hexchat update-manager indicator-multiload xclip (used by xcopy.sh) gvim wmctrl (used by gvim) ]'
        S apt-get install xterm xfce4-terminal x11-apps gkrellm hexchat update-manager indicator-multiload xclip vim-gtk3 wmctrl
